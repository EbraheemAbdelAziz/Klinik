export const MedicinesData = [
  ...
  },
  {
    ...
    treatment: [
      ...
      "Also used to decrease the risk of stroke in patients",
    ],
    sideEffects: [
      "Nausea, vomiting, constripation, dizziness, deowsiness",
      "Serious side effects may include slow or irregular heartbeat, chest tightness, and addiction",
  ...
  },
  {
    ...
    treatment: [
      "Asthma attacks",
      "It helps relax the muscles in thhe airways for easier breathing",
    ],
    sideEffects: [
      "Nausea, vomiting, constripation, dizziness, deowsiness",
      "Serious side effects may include slow or irregular heartbeat, chest tightness, and addiction",
  ...
  },
  {
    ...
    treatment: ["Used to treat Symptoms of most allergies"],
    sideEffects: [
      "Nausea, vomiting, constripation, dizziness, deowsiness",
      "Serious side effects may include slow or irregular heartbeat, chest tightness, and addiction",
    ],
